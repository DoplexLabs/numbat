...
Version 0.4.0 adds optional `session_tree_id`, `parent_session_id`, and
`sub_agent_id` context to events, findings, and enforcement records. Records
are stamped `0.4.0`; consumers that validate versions or closed schemas must
