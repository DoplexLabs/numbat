...
func TestVerifyRejectsTraversalManifest(t *testing.T) {
	...
	m := Manifest{SchemaVersion: "0.4.0", CaseID: "c", Tool: "numbat", Files: []ManifestFile{
...
func TestValidateManifestEvidenceMetadata(t *testing.T) {
	...
	base := func(mode string, evidence ManifestFile) Manifest {
		...
		return Manifest{
			SchemaVersion: "0.4.0", CaseID: "case-1", CreatedAt: "2026-06-10T12:00:00Z",
...
func TestVerifyRejectsUnknownManifestField(t *testing.T) {
	dir := t.TempDir()
	raw := `{"schema_version":"0.4.0","case_id":"c","created_at":"2026-06-10T12:00:00Z","tool":"numbat","tool_version":"test","files":[],"surprise":true}`
